...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('public/'); ?>css/owlcarousel.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
  ...
  <body class="landing-wrraper">
    ...
    <div class="page-wrapper landing-page">
      ...
      <div class="page-body-wrapper">
        ...
        <!-- header end-->
        <!--home section start-->
        <section class="landing-home section-pb-space" id="home"><img class="img-fluid bg-img-cover" src="<?= base_url('public/'); ?>images/landing/landing-home/home-bg2.jpg" alt="">
          <div class="custom-container">
            <div class="row">
              <div class="col-12">
          ...
          <div class="position-block">   
            ...
            <ul class="animat-block">
              <li><img class="img-fluid img-parten top-parten" src="<?= base_url('public/'); ?>images/landing/landing-home/home-position/img-parten.png" alt="">
    ...
    <!-- Plugins JS start-->
    <script src="<?= base_url('public/'); ?>js/owlcarousel/owl.carousel.js"></script>
    <script src="<?= base_url('public/'); ?>js/owlcarousel/owl-custom.js"></script>
    <script src="<?= base_url('public/'); ?>js/landing_sticky.js"></script>
    <script src="<?= base_url('public/'); ?>js/landing.js"></script>
    <script src="<?= base_url('public/'); ?>js/jarallax_libs/libs.min.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
